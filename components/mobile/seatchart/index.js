...
import Header from '../header/seatchart'
...
class seatchart extends React.Component {
    ...
    showCanvas = () => {
        ...
        // return <Seatchart
        //     seat = { this.state.seatchart }
        //     width = { this.state.lowerDeckWidth }
        //     isLower = { this.state.lower }
        //     clickSCFn = { this.state.clickSCFn }
        // />
        return (
                ...
                {/* <div className = "seatchart"> */}
                    {
                        ...
                        <div className = "flsbc layout-btn">
                            ...
                            >Lower({ seat.AvailSeats.Lower } Seats)</div>
                            <div
                                className = { !this.state.lower && 'active' }
                                onClick = { () => this.setState({ lower: false }) }
                            >Upper({ seat.AvailSeats.Upper } Seats)</div>
                        </div>
                    }
